...
var projectName = "Scissors.Utils";
...
public class BuildContext
{
    ...
    public BuildContext(string projectName, ICakeContext context)
    {
        ...
        Target = String.IsNullOrEmpty(context.Argument<string>("target", "Default")) ? "Default" : context.Argument<string>("target", "Default");
        ...
        ArtifactsDir =  context.Directory("./bin");
        Solutions = context.GetFiles("./*.sln");
